...
async function fetchPGCRWithRetry(
  ...
  try {
    ...
    // Original logic checked res.ok and 429. shimFetchPGCR throws on error.
    // I need to handle 429 in catch block or modify shim to return full response.
    // Shim returns axios response.data.
    
    // Let's modify shim later to return cleaner errors or handle here.
    // If shim throws, we catch it.
